...
- [새 애플리 케이션 등록](https://velog.io/@tpgus758/React%EC%97%90%EC%84%9C-Kakao-map-API-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0)
- vite : `http://localhost:5173`
- CRA : `http://localhost:3000`
- jsKey : `ab3490239c5b44b3b839657df0198316`
- 카카오 맵 활성화 필수
...
<html lang="ko">
  <head>
    ...
    <script
      type="text/javascript"
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ab3490239c5b44b3b839657df0198316"
    ></script>
  </head>
  <body>
    <div id="root"></div>
...
- [사용법 블로그](https://velog.io/@wlwl99/React-Kakao-Map-SDK-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0)
